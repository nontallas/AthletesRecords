...
public class Top5Select implements Command{
    private Queue<String> results = new LinkedList<>();
    private Connector connector = new Connector();
    private String gender;
    private String distance;
    private final String CONDITIONS = "group by athletes.a_name order by events.e_time limit 5;";
    ...
    public void execute() {
        final String QUERY = "select athletes.a_name, min(events.e_time) as time" +
                ...
                "where events.e_sport = '400' " + getCONDITIONS();
